...
RegisterNetEvent('ak47_iceboxv2:openbossaction')
AddEventHandler('ak47_iceboxv2:openbossaction', function()
...
RegisterNetEvent('ak47_iceboxv2:notify')
AddEventHandler('ak47_iceboxv2:notify', function(msg)
    ESX.ShowNotification(msg)
end)

RegisterNetEvent('ak47_iceboxv2:progress')
AddEventHandler('ak47_iceboxv2:progress', function(msg, time)
